...
public class FieldConstants {
    ...
    public static final Pose2d kClimbLeftPose = new Pose2d(1.343, 4.7616, Rotation2d.fromDegrees(0));
    public static final Pose2d kClimbRightPose = new Pose2d(1.343, 3.358, Rotation2d.fromDegrees(0));
