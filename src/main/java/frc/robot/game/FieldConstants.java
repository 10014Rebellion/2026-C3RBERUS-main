...
public class FieldConstants {
    ...
    public static final Pose2d kClimbRightPose = new Pose2d(1.576, 3.27, Rotation2d.fromDegrees(0));
    public static final Pose2d kClimbLeftPose = new Pose2d(1.576, 4.17, Rotation2d.fromDegrees(0));
