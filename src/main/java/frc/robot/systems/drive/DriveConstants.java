...
public class DriveConstants {
    ...
    public static final PIDConstants kPPTranslationPID = new PIDConstants(5.5, 0.0, 0.0); // TODO: TUNE ME
    public static final PIDConstants kPPRotationPID = new PIDConstants(2.5, 0.0, 0.0); // TODO: TUNE ME
