...
public interface RDetectCameraIO {
    @AutoLog
    public static class RDetectCameraIOInupts {
    ...
    public default void updateInputs(RDetectCameraIOInupts inputs, Pose2d pLastRobotPose, Pose2d pSimOdomPose) {}
