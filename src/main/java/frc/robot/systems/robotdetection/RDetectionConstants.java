 ...
 */
public class RDetectionConstants {
    ...
    public static final RDetectionCameraHardware kLeftCamera = 
        new RDetectionCameraHardware(kFrontLeftCamName, kFrontLeftCamOrientation, kFrontLeftCamTransform);
    ...
    public static final RDetectionCameraHardware kRightCamera = 
        new RDetectionCameraHardware(kFrontLeftCamName, kFrontLeftCamOrientation, kFrontLeftCamTransform);
    ...
    public static record RDetectionCameraHardware(String name, Orientation orientation, Transform3d camTransform) {}
}